...
function continueContextFor(
  ...
  const rejectedSyntheticSnapshot = error.code === "CODEX_SYNTHETIC_SNAPSHOT_REJECTED";
  ...
  return JSON.stringify(
    {
      ...
      repairDirective: rejectedSyntheticSnapshot
        ? "The previous file snapshot was generated by deployRocket rather than returned directly by Codex. Generate a complete static Vite React project from scratch for the user's current requirements."
        : noChanges
